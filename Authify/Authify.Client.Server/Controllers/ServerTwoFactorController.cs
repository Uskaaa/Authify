...
[ApiController]
[Route("api/server-twofactor")]
[Authorize]
public class ServerTwoFactorController : ControllerBase
{
    private readonly ITwoFactorClaimService _twoFactorClaimService;

    public ServerTwoFactorController(ITwoFactorClaimService twoFactorClaimService)
    {
